...
def query_8(dataset_path, fs):
    ...
    supplier = _read_parquet(dataset_path + "supplier", filesystem=fs)
    lineitem = _read_parquet(dataset_path + "lineitem", filesystem=fs)
    orders = _read_parquet(dataset_path + "orders", filesystem=fs)
    customer = _read_parquet(dataset_path + "customer", filesystem=fs)
    nation = _read_parquet(dataset_path + "nation", filesystem=fs)
    region = _read_parquet(dataset_path + "region", filesystem=fs)
    part = _read_parquet(dataset_path + "part", filesystem=fs)
...
def query_9(dataset_path, fs):
    ...
    part = _read_parquet(dataset_path + "part", filesystem=fs)
    partsupp = _read_parquet(dataset_path + "partsupp", filesystem=fs)
    supplier = _read_parquet(dataset_path + "supplier", filesystem=fs)
    lineitem = _read_parquet(dataset_path + "lineitem", filesystem=fs)
    orders = _read_parquet(dataset_path + "orders", filesystem=fs)
    nation = _read_parquet(dataset_path + "nation", filesystem=fs)
